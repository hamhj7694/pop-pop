...
export function TodayFindsOverlay({ isOpen, onClose }: TodayFindsOverlayProps) {
  ...
  return (
    <section
      className="fixed inset-x-0 bottom-0 z-30 max-h-[82vh] overflow-hidden rounded-t-lg border border-slate-200 bg-white shadow-2xl"
      aria-label="오늘 주운 것들"
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 p-4">
        ...
        <div className="grid min-h-0 gap-4 md:grid-cols-[1fr_20rem]">
                ...
                {filteredRewards.map((obtainedReward) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => selectReward(obtainedReward.id)}
                    >
